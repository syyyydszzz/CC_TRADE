...
class SmaCrossover(QCAlgorithm):
    def initialize(self):
        ...
        self.fast = self.sma(self.primary_symbol, 20, Resolution.DAILY)
        self.slow = self.sma(self.primary_symbol, 50, Resolution.DAILY)
    ...
    def on_data(self, slice: Slice):
        ...
        if self.fast.current.value > self.slow.current.value:
            ...
            self.liquidate(self.primary_symbol)
